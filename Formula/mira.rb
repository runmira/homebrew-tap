...
class Mira < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "e1309da6771fa2650b931062c588dba547921eb074947d6c85cef4d65e21cb30"
    end

    on_intel do
      url "https://github.com/runmira/mira/releases/download/v#{version}/mira-darwin-x86_64.tar.gz"
      sha256 "bdca21ae173ab2a801c050d76809558ec29b98ba00e924b0de20cbf7564bb42f"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "57a5a7934834fdb72c2b8530bae49e213ab64243310cd31a1e804cf8700e22e6"
    end

    on_intel do
      url "https://github.com/runmira/mira/releases/download/v#{version}/mira-linux-x86_64.tar.gz"
      sha256 "9ccdffcfcde7e191ca58adf5032465d2027155d61cd4ee35f6f58063c03efd2f"
    end
  end
